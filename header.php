...
<!-- top bar -->
<div class="top" style="background-color: #F0EFEF">
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						<li style="color:black"><i class="fa fa-phone" style="color:black"></i> <?php echo $contact_phone; ?></li>
						<li style="color:black"><i class="fa fa-envelope-o" style="color:black"></i> <?php echo $contact_email; ?></li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="right">
					<ul>
						...
						foreach ($result as $row) {
							...
							<li><a href="<?php echo $row['social_url']; ?>"><i class="<?php echo $row['social_icon']; ?>" style="color:black"></i></a></li>
							<?php endif; ?>
							<?php
						}
						?>
