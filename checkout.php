...
<form action="payment/bank/init.php" method="post" id="bank_form">
    ...
    max-width: 100%;
    margin-bottom: 5px;
    font-weight: 700;">Transition information</label>
        <p class="message" >Before proceeding with payment, please review your details carefully. </p>
        
        <table id="transaction_table" style="border-collapse: collapse; width: 100%; max-width: 400px; margin: auto;">
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="text" name="account_title" placeholder="Account Title" required style="width: 100%; padding: 8px;"></td>
    </tr>
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="text" name="transition_id" placeholder="Bank Name" required style="width: 100%; padding: 8px;"></td>
    </tr>
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="text" name="transition_id" placeholder="Transition ID" required style="width: 100%; padding: 8px;"></td>
    </tr>
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="text" name="name" placeholder="Customer Name" required style="width: 100%; padding: 8px;"></td>
    </tr>
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="tel" name="name" placeholder="Phone" required style="width: 100%; padding: 8px;"></td>
    </tr>
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;">
            <select name="country_name" required style="width: 100%; padding: 8px;">
    ...
    <!-- New row for Date -->
    <tr style="border-bottom: 1px solid #ddd;">
        <td style="padding: 10px;"><input type="date" name="transaction_date" placeholder="Date" required style="width: 100%; padding: 8px;"></td>
    </tr>
</table>
    ...
    <div class="col-md-12 form-group">
        <input type="submit" id="submitbtn" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form3">
    </div>
</form>

<script>
document.getElementById("bank_form").addEventListener("submit", function(event) {
    var table = document.getElementById('transaction_table');

    // Check if any input fields are empty
    for (var i = 0; i < table.rows.length; i++) {
        var input = table.rows[i].querySelector('input, select');
    ...
    textarea.name = 'transaction_info';
    textarea.style.display = 'none'; // Hide the textarea
    var text = "";
     let titles = ["Account Title: ","Bank Name: ","Transition Id: ","Customer Name: ","Phone: ","Country: ","Date: ",]
    // Loop through each row of the table
    for (var i = 0; i < table.rows.length; i++) {
        var cells = table.rows[i].cells;
        // Concatenate the input values from each row
        text += titles[i];
        text += cells[0].querySelector('input, select').value + ". ";
    }

    // Set the concatenated text as the value of the textarea
    textarea.value = text;
