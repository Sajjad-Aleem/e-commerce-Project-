...
<div class="page">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group ">
                                    <label for="cust_password">
                                        <?php echo LANG_VALUE_96; ?> *
                                    </label>
                                    <div class="input-group eye-container">
                                        <input type="password" maxlength="20" class="form-control psd-input"
                                            id="cust_password" name="cust_password">
                                        <div class="input-group-append eye-btn-container">
                                            <button class="btn btn-outline-secondary eye-btn" type="button"
                                                id="togglePassword" style="outline: none">
    ...
    <script>
        document.getElementById('togglePassword').addEventListener('click', function () {
            ...
            this.querySelector('i').className = type === 'password' ? 'fa fa-eye-slash' : 'fa fa-eye';
        });
    </script>
</div>
